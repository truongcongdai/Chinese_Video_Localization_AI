...
VOICE_OPTIONS: Dict[str, List[VoiceOption]] = {
    "vi": [
        ...
        {"id": "vi-VN-HoaiMyNeural|rate=+14%|pitch=+4Hz", "label": "Nữ creator trẻ, nhanh"},
        {"id": "vi-VN-NamMinhNeural|rate=+12%|pitch=+3Hz", "label": "Nam creator trẻ, nhanh"},
        {"id": "vi-VN-HoaiMyNeural|rate=-8%|pitch=-2Hz", "label": "Nữ review ấm, rõ"},
        {"id": "vi-VN-NamMinhNeural|rate=-8%|pitch=-4Hz", "label": "Nam review trầm, rõ"},
        {"id": "vi-VN-HoaiMyNeural|rate=+6%|pitch=+1Hz", "label": "Nữ bán hàng tự nhiên"},
        {"id": "vi-VN-NamMinhNeural|rate=+4%|pitch=-1Hz", "label": "Nam bán hàng tự nhiên"},
        {"id": "vi-VN-HoaiMyNeural|rate=-14%|pitch=-4Hz", "label": "Nữ kể chuyện chậm"},
        {"id": "vi-VN-NamMinhNeural|rate=-14%|pitch=-6Hz", "label": "Nam documentary chậm"},
        {"id": "vi-VN-HoaiMyNeural|rate=-4%|pitch=+5Hz", "label": "Nữ tươi sáng"},
        {"id": "vi-VN-NamMinhNeural|rate=-2%|pitch=+5Hz", "label": "Nam tươi sáng"},
